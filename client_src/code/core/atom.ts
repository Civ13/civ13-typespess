class Atom extends EventEmitter {
	constructor(client: any, instobj: any) {
		super();
	...
	set_overlay(key: string, value: { [x: string]: any; icon?: any; icon_state?: any; color?: any; overlay_layer?: any; }) {
	...
	set flick(val) {
		for (const overlay_renderer of this.overlay_renderers_list)
