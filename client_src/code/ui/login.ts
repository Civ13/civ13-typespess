...
<div><div class='button connect-button disabled'>Connect</div></div>`;
			...
			const login_button = this.panel.content_obj.getElementsByClassName(
				"login-button"
			)[0];
			const logout_button = this.panel.content_obj.getElementsByClassName(
				"logout-button"
			)[0];
			const connect_button = this.panel.content_obj.getElementsByClassName(
				"connect-button"
			)[0];
