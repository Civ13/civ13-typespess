...
<div><div class='button connect-button disabled'>Connect</div></div>`;
			...
			let login_button = this.panel.content_obj.getElementsByClassName(
				"login-button"
			)[0];
			let logout_button = this.panel.content_obj.getElementsByClassName(
				"logout-button"
			)[0];
			let connect_button = this.panel.content_obj.getElementsByClassName(
				"connect-button"
			)[0];
