class StripPanel {
	...
	handle_message(msg: { layout: any; layout_names: any[]; covered: { [s: string]: unknown; } | ArrayLike<unknown>; item_names: { [s: string]: unknown; } | ArrayLike<unknown>; item_appearances: { [s: string]: unknown; } | ArrayLike<unknown>; }) {
		console.log(msg);
		if (msg.layout) {
