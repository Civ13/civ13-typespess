...
class Atom extends EventEmitter {
	...
	force_move(x, y, z, dim, bounds_x, bounds_y, bounds_width, bounds_height) {
		this[_changeloc](
			x,
			y,
			z,
	...
	resize(bounds_x, bounds_y, bounds_width, bounds_height) {
		this[_changeloc](
			this[_x],
			this[_y],
			this[_z],
	...
	set loc(newLoc) {
		...
		if (newLoc !== null && newLoc.is_fine_loc) {
			if (!Object.prototype.hasOwnProperty.call(newLoc,"x") || !newLoc.hasOwnProperty.call(newLoc,"y")) {
	...
	get base_loc() {
		...
		while (this && !this.is_base_loc) var a = this.loc;
		return a;
	}
