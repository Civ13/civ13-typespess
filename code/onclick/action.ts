export{};
const {Atom, Component, has_component, make_watched_property} = require("./../../code/game/server.js");
...
class Action /*lawsuit*/ extends EventEmitter {
	...
	click_act(user: Record<string, any>) {
...
class ItemActions extends Component {
	...
	moved(e: {old: {loc: any}; new: {loc: any}}) {
		if (e.old && e.new && e.old.loc === e.new.loc) {
			return;
		} // nothing changed stop rearranging my buttons ree
