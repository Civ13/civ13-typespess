...
class ZoneSel extends Component {
	...
	clicked(e: Record<string,any>) {
		...
		if (py >= 1 && py < 10) {
			// legs
			if (px >= 10 && px < 16) {choice = "r_leg";}
			else if (px >= 17 && px < 23) {choice = "l_leg";}
			else {return;}
		} else if (py >= 10 && py < 14) {
			//Hands and groin
			if (px >= 8 && px < 12) {choice = "r_arm";}
			else if (px >= 12 && px < 21) {choice = "groin";}
			...
			if (px >= 12 && px < 21) {
				choice = "head";
				if (py >= 23 && py < 25 && px >= 15 && px < 18) {choice = "mouth";}
				else if (py >= 26 && py < 27 && px >= 14 && px < 19) {choice = "eyes";}
				else if (py >= 25 && py < 28 && px >= 15 && px < 18) {choice = "eyes";}
			} else {
				return;
			}
		} else {
