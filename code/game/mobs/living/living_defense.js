...
module.exports = {
	...
	run_armor_check(
		...
		if (armor && armour_penetration) {
			...
			if (penetrated_text) {
				...
				to_chat`<span class='userdanger'>Your armor was penetrated!</span>`(
					this.a
				);
			}
		} else if (armor >= 100) {
			if (absorb_text) {
				...
				to_chat`<span class='userdanger'>Your armor absorbs the blow!</span>`(
					this.a
				);
			}
		} else if (armor > 0) {
			if (soften_text) {
				...
				to_chat`<span class='userdanger'>Your armor softens the blow!</span>`(
					this.a
				);
			}
		}
	...
	bullet_act(projectile, def_zone) {
		let armor = this.run_armor_check(def_zone, projectile.c.Projectile.flag, {
