const { Component, Atom } = require("./../../../../../../code/game/server.ts");

const _ = require("underscore");
const { cable_colors } = require("../../../../../modules/power/cable.ts");
	...
	toolbox_electrical: {
		...
		vars: {
			components: {
				...
				StorageItem: {
					populate_contents() {
						const picked_color = _.sample(Object.keys(cable_colors));
						new Atom(this.a.server, "screwdriver", this.a);
						//TODO: T-Ray scanner
						new Atom(this.a.server, "wirecutters", this.a);
						new Atom(this.a.server, "crowbar", this.a);
						const cable_template = {
							components: ["StackCable"],
							vars: {
								components: {
									StackCable: { cable_color: picked_color },
									Stack: { amount: 30 },
								},
							},
						};
